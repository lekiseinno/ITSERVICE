...
<body>
	...
	<div class="card">
		<div class="card-body text-center">
			<h3><?php echo get_comname($_GET[com_ID]); ?></h3>
		</div>
	</div>
							...
							<div class="col-md-3 col-xs-3 col-sm-3 text-right">
								...
								<script type="text/javascript">
									$("#selectchart3").change(function(){
										window.location.href='report.php?com_ID=<?php echo $_GET[com_ID]; ?>&chart3_m='+ $("#selectchart3").val() +'#chart3_m';
									})
								</script>
							</div>
						</div>
							...
							<label class="labelcount">
								...
								if($_GET['chart3_m'] != "")
								{
									$sql	=	"
												SELECT	COUNT(*) as 'cou'
												FROM	iservices
												WHERE	service_Date_Start LIKE '".$_GET['chart3_m']."%'
												AND		com_ID	=	'".$_GET[com_ID]."'
												";
								...
								else
								{
									$sql	=	"
												SELECT	COUNT(*) as 'cou'
												FROM	iservices
												WHERE	service_Date_Start LIKE '".date('Y-m')."%'
												AND		com_ID	=	'".$_GET[com_ID]."'
												";
						...
						<div class="card-body text-center">
							<label class="labelcount">
								...
								$sql	=	"
											SELECT	COUNT(*) as 'cou'
											FROM	iservices
											WHERE	service_Date_Start LIKE '".date('Y')."%'
											AND		com_ID	=	'".$_GET[com_ID]."'
											";
								$query	=	mysqli_query($connect,$sql) or die(mysqli_error());
								$row	=	mysqli_fetch_array($query,MYSQLI_ASSOC);
							...
							<div class="col-md-3 col-xs-3 col-sm-3 text-right">
								...
								<script type="text/javascript">
									$("#selectchart5").change(function(){
										window.location.href='report.php?com_ID=<?php echo $_GET[com_ID]; ?>&chart5_m='+ $("#selectchart5").val() +'#chart5_m';
									})
								</script>
							</div>
						</div>
							...
							<div class="col-md-3 col-xs-3 col-sm-3 text-right">
								...
								<script type="text/javascript">
									$("#selectchart7").change(function(){
										window.location.href='report.php?com_ID=<?php echo $_GET[com_ID]; ?>&chart7_m='+ $("#selectchart7").val() +'#chart7_m';
									})
								</script>
							</div>
						</div>
							...
							<div class="col-md-3 col-xs-3 col-sm-3 text-right">
								...
								<script type="text/javascript">
									$("#selectchart9").change(function(){
										window.location.href='report.php?com_ID=<?php echo $_GET[com_ID]; ?>&chart9_m='+ $("#selectchart9").val() +'#chart9_m';
									})
								</script>
							</div>
						</div>
